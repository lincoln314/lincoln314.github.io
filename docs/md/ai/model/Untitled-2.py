...
def main():
	...
	for i, (img_batch, mel_batch, frames, coords) in enumerate(tqdm(gen, 
		...
		if i == 0:
			...
			ort_session = onnxruntime.InferenceSession("/data/pkg/virtual/wav2lip1.onnx",providers=['TensorrtExecutionProvider', 'CUDAExecutionProvider', 'CPUExecutionProvider'])
